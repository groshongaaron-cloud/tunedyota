...
module.exports = {
  ...
  "des moines": [
    ...
    { dateISO: "2027-05-08", label: "May 8, 2027", active: true, event: "Des Moines, Iowa Spring 2027 OTT Event", details: "", address: "To Be Released" },
  ],
  "omaha": [
    ...
    { dateISO: "2027-05-15", label: "May 15, 2027", active: true, event: "Omaha, Nebraska Spring 2027 OTT Event", details: "", address: "To Be Released" },
  ],
  "twin cities": [
  ...
  "fargo": [
    ...
    { dateISO: "2027-06-26", label: "June 26, 2027", active: true, event: "Fargo, North Dakota Summer 2027 OTT Event", details: "", address: "To Be Released" },
  ],
  "madison": [
    ...
    { dateISO: "2027-05-22", label: "May 22, 2027", active: true, event: "Madison, Wisconsin Spring 2027 OTT Event", details: "", address: "To Be Released" },
  ],
  "duluth": [
    ...
    { dateISO: "2027-07-10", label: "July 10, 2027", active: true, event: "Duluth, Minnesota Summer 2027 OTT Event", details: "", address: "To Be Released" },
  ],
  "green bay": [
    ...
    { dateISO: "2027-06-12", label: "June 12, 2027", active: true, event: "Green Bay, Wisconsin Summer 2027 OTT Event", details: "", address: "To Be Released" },
  ...
  "sioux falls": [
    ...
    { dateISO: "2027-06-19", label: "June 19, 2027", active: true, event: "Sioux Falls, South Dakota Summer 2027 OTT Event", details: "", address: "To Be Released" },
  ...
  "rochester": [
    ...
    { dateISO: "2027-07-24", label: "July 24, 2027", active: true, event: "Rochester, Minnesota Summer 2027 OTT Event", details: "", address: "To Be Released" },
  ],
  "mankato":     { dateISO: "2027-07-25", label: "July 25, 2027", active: true, event: "Mankato, Minnesota Summer 2027 OTT Event", details: "", address: "To Be Released" },
  ...
  "lincoln":     { dateISO: "2027-05-16", label: "May 16, 2027", active: true, event: "Lincoln, Nebraska Spring 2027 OTT Event", details: "", address: "To Be Released" },
  "sioux city":  { dateISO: "2027-06-20", label: "June 20, 2027", active: true, event: "Sioux City, Iowa Summer 2027 OTT Event", details: "", address: "To Be Released" },
};
