...
// the platform-specific tiers OTT uses on the 2024+ turbo trucks (Tacoma 2024+,
// 4Runner 2025+, LC250): the Stage tiers and Mild-Spicy. The installer console
// only OFFERS those tiers on those platforms; this list is what the server
// ACCEPTS, so it carries all of them.
// "Stage 1 Enhanced" (no dash) is the legacy spelling — kept accepted so cached
// consoles and pre-rename records still close out; the console now offers the
// dashed labels only.
const CAL_OPTIONS = ["Light", "Mild", "Medium", "Spicy", "SS", "Light and Mild", "Mild and Medium", "Medium and Spicy", "Spicy and SS", "Stage 1 - Basic", "Stage 1 - Enhanced", "Stage 1 Enhanced", "Stage 2", "Stage 3", "Mild-Spicy"];
