...
test("pre-fills known fields, blanks the installer fields, names customer in subject", () => {
  const { subject, html } = buildCertificate({ name: "Jane Driver", retailer: "Cody Star", vehicle: "2024+ Toyota Tacoma", calibrationDate: "2026-06-28" });
  ...
  assert.ok(html.includes("2024+ Toyota Tacoma"));
